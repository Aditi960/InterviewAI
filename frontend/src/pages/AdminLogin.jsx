    ...
    <div className="min-h-screen flex flex-col md:flex-row" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
      ...
      <div className="hidden md:flex md:w-1/2 flex-col justify-center p-10 lg:px-10 text-white" style={{ background: 'linear-gradient(135deg, #0891b2 0%, #06b6d4 50%, #22d3ee 100%)' }}>
        ...
        <p style={{ opacity: 0.85, fontSize: 16, lineHeight: 1.6, marginBottom: 40, maxWidth: 340 }}>
          Restricted access. Admins only. Manage users, monitor interviews, and oversee the platform.
        </p>
        {['Manage users & roles', 'Monitor interview sessions', 'Platform analytics & settings'].map(item => (
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-10" style={{ background: darkMode ? '#0f172a' : '#fafafa' }}>
        <div className="w-full max-w-[380px]">
          <h3 className="break-words" style={{ fontFamily: 'Syne, sans-serif', fontSize: 26, fontWeight: 700, marginBottom: 6, color: darkMode ? '#f1f5f9' : '#1e293b' }}>Admin Portal</h3>
          <p style={{ color: '#94a3b8', fontSize: 14, marginBottom: 32 }}>Restricted access. Admins only.</p>
          ...
          <p style={{ textAlign: 'center', fontSize: 14, color: darkMode ? '#94a3b8' : '#64748b', marginTop: 20 }}>
            Not an admin?{' '}
            <Link to="/login" style={{ color: '#06b6d4', textDecoration: 'none', fontWeight: 600 }}>User Login</Link>
          </p>
        </div>
      </div>
    </div>
