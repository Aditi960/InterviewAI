    ...
    <div style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', background: '#fdf6f6', minHeight: '100vh' }}>
      ...
      <section style={{ textAlign: 'center', padding: '80px 40px 40px', background: 'linear-gradient(180deg, #fef9c3 0%, #fdf6f6 100%)', position: 'relative', overflow: 'hidden' }}>
        <div style={{
          ...
          background: 'rgba(255,255,255,0.8)', borderRadius: 100, marginBottom: 24,
          fontSize: 13, fontWeight: 500, color: '#475569', border: '1px solid #e2e8f0',
        ...
        <h1 style={{ fontFamily: 'Syne, sans-serif', fontSize: 'clamp(40px, 6vw, 72px)', fontWeight: 800, lineHeight: 1.1, marginBottom: 20, color: '#1e293b' }}>
          Ace Your Interviews
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <button style={{ background: 'white', color: '#1e293b', padding: '14px 28px', borderRadius: 14, border: '1.5px solid #e2e8f0', fontSize: 15, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <section id="features" style={{ padding: '80px 40px', maxWidth: 1000, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
          {features.map(({ icon, color, title, desc }) => (
            <div key={title} style={{ background: 'white', borderRadius: 20, padding: 28, boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #f1f5f9' }}>
              ...
              <h3 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 17, marginBottom: 10, color: '#1e293b' }}>{title}</h3>
              <p style={{ color: '#64748b', lineHeight: 1.65, fontSize: 14, margin: 0 }}>{desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ padding: '60px 40px', background: 'white' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 32, color: '#1e293b', marginBottom: 10 }}>Authentication Flow UI</h2>
          <p style={{ color: '#64748b', fontSize: 15 }}>Clean, secure, and production-ready components designed for JWT and OAuth integrations.</p>
        </div>
        <div style={{ display: 'flex', gap: 20, justifyContent: 'center', flexWrap: 'wrap', maxWidth: 900, margin: '0 auto' }}>
          <div style={{ background: '#f8fafc', borderRadius: 16, padding: 24, width: 240, border: '1px solid #e2e8f0' }}>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <div style={{ background: 'white', border: '1px solid #e2e8f0', borderRadius: 8, padding: '8px 12px', fontSize: 13, color: '#94a3b8' }}>you@example.com</div>
            </div>
            <div style={{ marginBottom: 16 }}>
              <label style={{ fontSize: 12, color: '#64748b', display: 'block', marginBottom: 4 }}>Password</label>
              <div style={{ background: 'white', border: '1px solid #e2e8f0', borderRadius: 8, padding: '8px 12px', fontSize: 13, color: '#94a3b8' }}>••••••••</div>
            </div>
          ...
          <div style={{ background: '#f8fafc', borderRadius: 16, padding: 24, width: 240, border: '1px solid #e2e8f0' }}>
            ...
            {['Full Name', 'Email', 'Password', 'Confirm Password'].map(field => (
              <div key={field} style={{ marginBottom: 10 }}>
                ...
                <div style={{ background: 'white', border: '1px solid #e2e8f0', borderRadius: 8, padding: '8px 12px', fontSize: 13, color: '#94a3b8' }}>
